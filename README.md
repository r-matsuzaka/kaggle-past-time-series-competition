...
| Pos | <div style="width:100px">methods</div> | <div style="width:130px">Ensemble method</div> | data split method | Code                                                                                                                   | Discussion |
|-----|-----------------------------|------------------------------------------------|---------------|------------------------------------------------------------------------------------------------------------------------|-----|
...
| 3   | Conv1d<br/> <br/>Stacked LSTM | random seed average                            | Stratified K-Folds| NA                                                                                                                     | [[3rd Place] Single model scored 0.0975 w/o PID controller](https://www.kaggle.com/c/ventilator-pressure-prediction/discussion/285330#1570563)|


### 17. [Optiver Realized Volatility Prediction](https://www.kaggle.com/c/optiver-realized-volatility-prediction/overview)
[> Go to top](#Review-of-kaggle-time-series-competition)

| Pos | <div style="width:100px">methods</div> | <div style="width:130px">Ensemble method</div> | <div style="width:120px">data split method</div> | <div style="width:200px">Code</div>                                                                        | <div style="width:200px">Discussion</div>                                                                                                      |
|-----|----------------------------------------|------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
